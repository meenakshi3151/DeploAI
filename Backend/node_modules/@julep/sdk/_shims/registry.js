...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import '@julep/sdk/shims/${shims.kind}'\` before importing anything else from @julep/sdk`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import '@julep/sdk/shims/${shims.kind}'\` after \`import '@julep/sdk/shims/${exports.kind}'\``);
    }

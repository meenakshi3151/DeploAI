...
export declare class Docs extends APIResource {
     ...
     * Create Agent Doc
     */
    create(agentId: string, params: DocCreateParams, options?: Core.RequestOptions): Core.APIPromise<DocsAPI.Doc>;
    /**
     * List Agent Docs
     */
    list(agentId: string, query?: DocListParams, options?: Core.RequestOptions): Core.PagePromise<DocsOffsetPagination, DocsAPI.Doc>;
    list(agentId: string, options?: Core.RequestOptions): Core.PagePromise<DocsOffsetPagination, DocsAPI.Doc>;
    /**
     * Delete Agent Doc
     */
    delete(agentId: string, docId: string, options?: Core.RequestOptions): Core.APIPromise<Shared.ResourceDeleted>;
    /**
     ...
     */
    search(agentId: string, params: DocSearchParams, options?: Core.RequestOptions): Core.APIPromise<DocSearchResponse>;
}
